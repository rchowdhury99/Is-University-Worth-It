...
domestic_undergraduate
join_domestic_undergrad = domestic_undergraduate %>% mutate(sum = n()-1)
...
domestic_graduate
join_domestic_grad = domestic_graduate %>% mutate(sum = n()+17)
join_domestic_grad
######################################################################################################################
...
international_graduate
join_international_grad = international_graduate %>% mutate(sum = n()+18)
