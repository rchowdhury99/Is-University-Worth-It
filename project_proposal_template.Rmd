...
The data we used and are planning to use are collected from online resources refered below. The first three resources below are URLs that provide an option to download a csv file corresponding to the data. The last resource (Payscale) shows the data about the salary of UofT allumnis and the data was obtained through webscraping.
...
***-Tuition and Living Accomodations for Full-time students (2017-2018)
